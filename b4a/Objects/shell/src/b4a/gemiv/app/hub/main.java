...
public static b4a.gemiv.app.hub.dbutils _dbutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"adddevice",main.mostCurrent._adddevice,"beginlisten",main.mostCurrent._beginlisten,"cleardevices",main.mostCurrent._cleardevices,"comando",main._comando,"comandos",main._comandos,"dbManager",main._dbmanager,"DBUtils",Debug.moduleToString(b4a.gemiv.app.hub.dbutils.class),"GemivGlobals",Debug.moduleToString(b4a.gemiv.app.hub.gemivglobals.class),"getcommand",main.mostCurrent._getcommand,"habitacion",main._habitacion,"habitaciones",main._habitaciones,"ip",main.mostCurrent._ip,"ipSwitch",main.mostCurrent._ipswitch,"listen",main.mostCurrent._listen,"mac",main.mostCurrent._mac,"nombreDispositivo",main.mostCurrent._nombredispositivo,"off",main.mostCurrent._off,"on",main.mostCurrent._on,"periferico",main._periferico,"perifericos",main._perifericos,"recText",main.mostCurrent._rectext,"response",main.mostCurrent._response,"runtimeAdmin",main._runtimeadmin,"Starter",Debug.moduleToString(b4a.gemiv.app.hub.starter.class),"TTS1",main.mostCurrent._tts1,"udpCom",main._udpcom,"voiceRec",main._voicerec};
}
}