...
try {
		Debug.PushSubsStack("CopyDBFromAssets (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,52);
...
try {
		Debug.PushSubsStack("CreateTable (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,94);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92752526",RemoteObject.concat(RemoteObject.createImmutable("CreateTable: "),_query),0);
...
try {
		Debug.PushSubsStack("DeleteRecord (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,468);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93735557",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93735567",RemoteObject.concat(RemoteObject.createImmutable("DeleteRecord: "),_sb.runMethod(true,"ToString")),0);
...
try {
		Debug.PushSubsStack("DropTable (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,114);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92818050",RemoteObject.concat(RemoteObject.createImmutable("DropTable: "),_query),0);
...
try {
		Debug.PushSubsStack("EscapeField (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,65);
...
try {
		Debug.PushSubsStack("ExecuteHtml (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,345);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93407879",RemoteObject.concat(RemoteObject.createImmutable("ExecuteHtml: "),_query),0);
...
try {
		Debug.PushSubsStack("ExecuteJSON (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,307);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93342344",RemoteObject.concat(RemoteObject.createImmutable("ExecuteJSON: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93342359",RemoteObject.concat(RemoteObject.createImmutable("Invalid type: "),_dbtypes.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),0);
 break; }
}
;
 }
...
try {
		Debug.PushSubsStack("ExecuteList (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,287);
...
try {
		Debug.PushSubsStack("ExecuteList2 (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,282);
...
try {
		Debug.PushSubsStack("ExecuteListView (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,238);
...
try {
		Debug.PushSubsStack("ExecuteMap (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,199);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93014664",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMap: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93014666",RemoteObject.createImmutable("No records found."),0);
...
try {
		Debug.PushSubsStack("ExecuteMemoryTable (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,174);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92949126",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMemoryTable: "),_query),0);
...
try {
		Debug.PushSubsStack("ExecuteSpinner (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,222);
...
try {
		Debug.PushSubsStack("GetDBFolder (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,39);
...
try {
		Debug.PushSubsStack("GetDBVersion (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,401);
...
try {
		Debug.PushSubsStack("GetFieldsInfo (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,500);
...
try {
		Debug.PushSubsStack("GetTables (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,494);
...
try {
		Debug.PushSubsStack("InsertMaps (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,124);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92883588",RemoteObject.createImmutable("Same Map found twice in list. Each item in the list should include a different map object."),0);
...
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92883612",RemoteObject.concat(RemoteObject.createImmutable("InsertMaps (first query out of "),_listofmaps.runMethod(true,"getSize"),RemoteObject.createImmutable("): "),_sb.runMethod(true,"ToString")),0);};
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92883617",BA.ObjectToString(dbutils.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("SetDBVersion (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,422);
...
try {
		Debug.PushSubsStack("TableExists (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,488);
...
try {
		Debug.PushSubsStack("UpdateRecord (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,428);
...
try {
		Debug.PushSubsStack("UpdateRecord2 (dbutils) ","dbutils",5,_ba,dbutils.mostCurrent,435);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93670018",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93670022",RemoteObject.createImmutable("Fields empty"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93670043",RemoteObject.concat(RemoteObject.createImmutable("UpdateRecord: "),_sb.runMethod(true,"ToString")),0);
