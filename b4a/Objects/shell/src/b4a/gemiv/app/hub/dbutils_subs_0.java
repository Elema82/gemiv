...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92621454",RemoteObject.concat(RemoteObject.createImmutable("CreateTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93604485",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93604495",RemoteObject.concat(RemoteObject.createImmutable("DeleteRecord: "),_sb.runMethod(true,"ToString")),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92686978",RemoteObject.concat(RemoteObject.createImmutable("DropTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93276807",RemoteObject.concat(RemoteObject.createImmutable("ExecuteHtml: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93211272",RemoteObject.concat(RemoteObject.createImmutable("ExecuteJSON: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93211287",RemoteObject.concat(RemoteObject.createImmutable("Invalid type: "),_dbtypes.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),0);
 break; }
}
;
 }
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92883592",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMap: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92883594",RemoteObject.createImmutable("No records found."),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92818054",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMemoryTable: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92752516",RemoteObject.createImmutable("Same Map found twice in list. Each item in the list should include a different map object."),0);
...
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92752540",RemoteObject.concat(RemoteObject.createImmutable("InsertMaps (first query out of "),_listofmaps.runMethod(true,"getSize"),RemoteObject.createImmutable("): "),_sb.runMethod(true,"ToString")),0);};
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","92752545",BA.ObjectToString(dbutils.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93538946",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93538950",RemoteObject.createImmutable("Fields empty"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93538971",RemoteObject.concat(RemoteObject.createImmutable("UpdateRecord: "),_sb.runMethod(true,"ToString")),0);
