...
try {
		Debug.PushSubsStack("CopyDBFromAssets (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,52);
...
try {
		Debug.PushSubsStack("CreateTable (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,94);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93604494",RemoteObject.concat(RemoteObject.createImmutable("CreateTable: "),_query),0);
...
try {
		Debug.PushSubsStack("DeleteRecord (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,468);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94587525",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94587535",RemoteObject.concat(RemoteObject.createImmutable("DeleteRecord: "),_sb.runMethod(true,"ToString")),0);
...
try {
		Debug.PushSubsStack("DropTable (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,114);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93670018",RemoteObject.concat(RemoteObject.createImmutable("DropTable: "),_query),0);
...
try {
		Debug.PushSubsStack("EscapeField (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,65);
...
try {
		Debug.PushSubsStack("ExecuteHtml (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,345);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94259847",RemoteObject.concat(RemoteObject.createImmutable("ExecuteHtml: "),_query),0);
...
try {
		Debug.PushSubsStack("ExecuteJSON (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,307);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94194312",RemoteObject.concat(RemoteObject.createImmutable("ExecuteJSON: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94194327",RemoteObject.concat(RemoteObject.createImmutable("Invalid type: "),_dbtypes.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),0);
 break; }
}
;
 }
...
try {
		Debug.PushSubsStack("ExecuteList (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,287);
...
try {
		Debug.PushSubsStack("ExecuteList2 (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,282);
...
try {
		Debug.PushSubsStack("ExecuteListView (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,238);
...
try {
		Debug.PushSubsStack("ExecuteMap (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,199);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93866632",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMap: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93866634",RemoteObject.createImmutable("No records found."),0);
...
try {
		Debug.PushSubsStack("ExecuteMemoryTable (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,174);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93801094",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMemoryTable: "),_query),0);
...
try {
		Debug.PushSubsStack("ExecuteSpinner (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,222);
...
try {
		Debug.PushSubsStack("GetDBFolder (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,39);
...
try {
		Debug.PushSubsStack("GetDBVersion (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,401);
...
try {
		Debug.PushSubsStack("GetFieldsInfo (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,500);
...
try {
		Debug.PushSubsStack("GetTables (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,494);
...
try {
		Debug.PushSubsStack("InsertMaps (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,124);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93735556",RemoteObject.createImmutable("Same Map found twice in list. Each item in the list should include a different map object."),0);
...
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93735580",RemoteObject.concat(RemoteObject.createImmutable("InsertMaps (first query out of "),_listofmaps.runMethod(true,"getSize"),RemoteObject.createImmutable("): "),_sb.runMethod(true,"ToString")),0);};
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","93735585",BA.ObjectToString(dbutils.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
try {
		Debug.PushSubsStack("SetDBVersion (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,422);
...
try {
		Debug.PushSubsStack("TableExists (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,488);
...
try {
		Debug.PushSubsStack("UpdateRecord (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,428);
...
try {
		Debug.PushSubsStack("UpdateRecord2 (dbutils) ","dbutils",7,_ba,dbutils.mostCurrent,435);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94521986",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94521990",RemoteObject.createImmutable("Fields empty"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","94522011",RemoteObject.concat(RemoteObject.createImmutable("UpdateRecord: "),_sb.runMethod(true,"ToString")),0);
