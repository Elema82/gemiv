...
try {
		Debug.PushSubsStack("getBroadcastIp (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("getMessageDatagram (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("Initialize (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("sendBroadcastUdp (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("sendDirectUdp (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,34);
...
public static RemoteObject  _setmessagedatagram(RemoteObject __ref,RemoteObject _data,RemoteObject _ip) throws Exception{
try {
		Debug.PushSubsStack("setMessageDatagram (gemivudpcomunication) ","gemivudpcomunication",5,__ref.getField(false, "ba"),__ref,57);
if (RapidSub.canDelegate("setmessagedatagram")) { return __ref.runUserSub(false, "gemivudpcomunication","setmessagedatagram", __ref, _data, _ip);}
...
Debug.ShouldStop(33554432);
__ref.getField(false,"_messagedatagram" /*RemoteObject*/ ).setField ("data" /*RemoteObject*/ ,_data);
 BA.debugLineNum = 59;BA.debugLine="messageDatagram.ip	 = ip";
Debug.ShouldStop(67108864);
__ref.getField(false,"_messagedatagram" /*RemoteObject*/ ).setField ("ip" /*RemoteObject*/ ,_ip);
