...
anywheresoftware.b4a.keywords.Common.LogImpl("93538958","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94521989","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94521999","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("93604482","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94194311","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94128776","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94128791","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("93801096","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("93801098","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("93735558","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("93670020","Same Map found twice in list. Each item in the list should include a different map object.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("93670044","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
_sql.TransactionSuccessful();
			...
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e32); //BA.debugLineNum = 157;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("93670049",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("94456450","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94456454","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("94456475","UpdateRecord: "+_sb.ToString(),0);
