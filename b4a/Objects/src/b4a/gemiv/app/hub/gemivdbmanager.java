...
__c.LogImpl("72490369","DirAssets: "+__c.File.getDirAssets(),0);
 //BA.debugLineNum = 45;BA.debugLine="Log(\"DirDefaultExternal: \"&File.DirDefaultExterna";
__c.LogImpl("72490370","DirDefaultExternal: "+__c.File.getDirDefaultExternal(),0);
 //BA.debugLineNum = 46;BA.debugLine="Log(\"DirInternal: \"&File.DirInternal)";
__c.LogImpl("72490371","DirInternal: "+__c.File.getDirInternal(),0);
 //BA.debugLineNum = 47;BA.debugLine="Log(\"DirInternalCache: \"&File.DirInternalCache)";
__c.LogImpl("72490372","DirInternalCache: "+__c.File.getDirInternalCache(),0);
 //BA.debugLineNum = 48;BA.debugLine="Log(\"DirRootExternal: \"&File.DirRootExternal)";
__c.LogImpl("72490373","DirRootExternal: "+__c.File.getDirRootExternal(),0);
